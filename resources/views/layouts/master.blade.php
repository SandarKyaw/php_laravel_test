        ...
        <div class="row offset-1 mt-4">
            ...
            <div class="col-10 mt-2">
                <ul class="nav nav-pills justify-content-between">
                    <div class="d-flex">
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin#dashBoard')}}">Doctors List</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('admin#userList')}}">User Lists</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="d-flex">
                        <li class="nav-item">
                            <a class="nav-link d-inline" href="{{route('admin#dcreatePage')}}">Create Doctor</a>
